...
def build_interpret_messages(board: DivinationBoard) -> list[dict]:
    """首轮解读的消息序列。"""
...
def build_chat_messages(board: DivinationBoard, history: list[dict]) -> list[dict]:
    """多轮追问：system + 盘面（作为 system 上下文）+ 历史对话。"""
